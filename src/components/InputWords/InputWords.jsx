...
function InputWords(props) {
    ...
    const [inputs, setInputs] = useState({english : '', transcription : '', russian : '', tags: ''  });
  ...
  const handleInputChange = (e) => {
    ...
    const addWords = () => {
     // if (e) { e.preventDefault()
      ...
      /* if(e.target.value === '')
       ...
       const newWord= { english: inputs.english,
    ...
    <tr>
        <td><input type="text" id="english" onChange={(e) => handleInputChange(e)} value={inputs.english} name="english" /> </td>
        <td><input type="text" id="transcription" onChange={(e) => handleInputChange(e)} value={inputs.transcription}  name="transcription" /></td>
        <td><input type="text" id="russian" onChange={(e) => handleInputChange(e)} value={inputs.russian} name="russian" /></td>
        <td><input type="text" id="tags" onChange={(e) => handleInputChange(e)} value={inputs.tags}  name="tags" /></td>
